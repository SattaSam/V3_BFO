(function (global) {
  ...
  const PRODUCTION_SPECS = Object.freeze([
    ...
    { id: "MAT-WOOD-M-001", type: "wood_plane", label: "Planche de bois", category: "constructions", subtype: "wood_plank", size: "M", rarity: "common", biomes: ["all"], scenes: ["Stock de matériaux", "Chantier de refuge", "Atelier de base"], states: ["brute", "taillée", "assemblée", "posée", "endommagée", "récupérée"], actions: ["inspect", "collect", "carry", "build", "repair", "dismantle"], defaultAction: "collect", collectable: true, inspectable: true, destructible: true, traversable: true, respawn: 600, inventoryKey: "wood_plank", exploitability: "craftable/building-material", family: "materials", resourceFamily: "materials", research: ["construction", "engineering", "materials"], tags: ["material", "wood", "plank", "construction", "inventory"], spawnCost: 2, maxPerZone: 20, minDistance: 0.4, maxSlope: 35, radius: 0.65, volume: "small", curiosity: 0.25, harvest: 0.85, missions: ["fabriquer un refuge", "construire une base", "réparer une structure"], events: ["OBJECT_CRAFTED", "OBJECT_COLLECTED", "OBJECT_USED", "OBJECT_BUILT"], decision: "validated" }
  ]);
