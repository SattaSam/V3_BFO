(function (global) {
  ...
  const BIOMES = list([
    ...
    biome("forest", "Forêt", 16, "common", 0.2,
      ...
      ["clearing", "giant_roots", "luminous_forest", "fungal_colony", "basin"]),
    ...
    biome("desert", "Désert", 7, "uncommon", 0.45,
      ...
      ["vitrified_dunes", "oasis", "exposed_crystals", "desert_wreck"]),
    ...
    biome("ruins", "Ruines", 7, "uncommon", 1.5,
      ...
      ["collapsed_arch", "stele_court", "debris_dump", "destroyed_workshop"]),
    ...
    biome("electrical", "Électrique", 2, "rare", 0.75,
      ...
      ["lightning_zone", "charged_crystals", "ancient_pylon", "conducting_pool"]),
